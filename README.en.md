...
The following results were generated by the current `main` Vulkan CLI on GPU 0 of an RTX 3090. The current release line has a maximum target of `256x256`.
